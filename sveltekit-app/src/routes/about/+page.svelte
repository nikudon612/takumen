...
<div class="about">
	...
	<div class="about_text">
		...
		<p>
			These interpretations led to Takumen's food and drink menu: eclectically mixed and casual food
			items, wines from California, Sake and Shochu from Japan, and craft beers from local Rockaway
			Brewery. Kiyo respected the original idea by keeping the noodle items on the menu. He adds:
		</p>
		...
		<p>
			...
			filled with condiments and ingredients used in the kitchen symbolizes Takumen's commitment to
			transparency.
		</p>

		<p>
			The mostly hand-built space was designed by Sachiko Kamiya of Monroe Garden, who also is
			Kiyo's partner. Inspired by their travels in California, its clean, bright, and breathy design
			will change your perspectives on Izakaya.
		</p>
